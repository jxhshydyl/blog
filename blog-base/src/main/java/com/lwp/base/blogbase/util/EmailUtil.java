package com.lwp.base.blogbase.util;
 ...
 * @Created by liuweipeng
 */
public class EmailUtil {
    private static String account = "czyun1@hmzx.tv";// 登录账户
    private static String password = "Yijiu2019.";// 登录密码
...
//@param fileSrc 附件地址
    ...
    public static void main(String[] args) {
        EmailUtil.send("","test","test","1098958507@qq.com","");
    }
}
